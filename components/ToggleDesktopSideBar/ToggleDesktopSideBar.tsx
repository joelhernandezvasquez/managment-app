...
const {desktopSideBarStatus,setDesktopSideBar} = useUIStates();
    ...
    return (
        <div className={style.toggle_desktop_sidebar_container}>
            {
              desktopSideBarStatus === 'display' || desktopSideBarStatus === 'open' ? (
                <button className={button.hide_desktop_side_bar_btn} onClick={()=> setDesktopSideBar('close')}>
