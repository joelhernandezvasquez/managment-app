...
export const ModalFormLayout:FC<Props> = ({children,closeModal,formTitle,formTitleColor}) => {
  ...
  return (
    <div ref={sidebarRef} className={layouts.modal_container}
      ...
      <div className={layouts.modal_header}>
          <h2 style={{color:`${formTitleColor}`}} className={layouts.modal_title}>{formTitle}</h2>
          <button className={button.close_button}  onClick={onCloseModalForm}>
